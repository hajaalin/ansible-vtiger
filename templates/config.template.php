...
$dbconfig['db_server'] = '{{ vtiger_db_server }}';
$dbconfig['db_port'] = ':{{ vtiger_db_port }}';
$dbconfig['db_username'] = '{{ vtiger_db_username }}';
$dbconfig['db_password'] = '{{ vtiger_db_password }}';
$dbconfig['db_name'] = '{{ vtiger_db_name }}';
$dbconfig['db_type'] = '{{ vtiger_db_type }}';
$dbconfig['db_status'] = '{{ vtiger_db_status }}';
...
// root directory path
$root_directory = '{{ vtiger_root_directory }}';

// cache direcory path
$cache_dir = '{{ vtiger_cache_directory }}';

// tmp_dir default value prepended by cache_dir = images/
$tmp_dir = '{{ vtiger_tmp_directory }}';

// import_dir default value prepended by cache_dir = import/
$import_dir = '{{ vtiger_import_directory }}';

// upload_dir default value prepended by cache_dir = upload/
$upload_dir = '{{ vtiger_upload_directory }}';
...
$currency_name = '{{ vtiger_master_currency }}';

// default charset
// default charset default value = 'UTF-8' or 'ISO-8859-1'
$default_charset = '{{ vtiger_default_charset }}';
...
$application_unique_key = '{{ vtiger_application_unique_key }}';
